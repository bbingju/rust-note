...
예를 들어, 아이템 개수가 60만개인 벡터에서 아이템을 낱개로 모두 삭제하려면 많은 시간이 걸린다.
...
#+begin_src rust :results output :exports both
  ...
  fn main() {
      ...
      println!("The time elapsed is {:?}", duration);
  }
#+end_src
...
이런 경우엔 ~VecDeque~ 를 사용하여 시간을 줄일 수 있다.
