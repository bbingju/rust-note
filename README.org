...
#+begin_src rust :results output :exports both
  ...
  impl Person {
      fn new(name: String, age: u8, tall: u8) -> Self {
          Self {
              name,
              age,
              tall
  ...
  fn main() {
      let me = Person {
          name: "Phil Hwang".to_string(),
          age: 44,
          tall: 186
      };

      let you = Person::new("John Doe".to_string(), 23, 178);
...
#+RESULTS:
: I am Person { name: "Phil Hwang", age: 44, tall: 186 }
: You are Person { name: "John Doe", age: 23, tall: 178 }
